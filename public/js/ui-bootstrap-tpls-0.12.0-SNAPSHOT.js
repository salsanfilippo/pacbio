 ...
 * License: MIT
 *
 * Version: 0.12.0 SNAPSHOT 2015-04-01
 * Fix for typeahead min length 0
 * Merged popover template window support (including tooltip changes) from 0.13.0,
 * an error occurs when showing/hiding standard popover.
 */
